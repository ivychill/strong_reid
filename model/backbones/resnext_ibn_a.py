...
class ResNeXt(nn.Module):
    ...
    """
    def __init__(self, last_stride, baseWidth, cardinality, layers, num_classes=1000):
        """ Constructor
        Args:
...
def resnext50_ibn_a(last_stride, baseWidth, cardinality):
    ...
    """
    model = ResNeXt(last_stride, baseWidth, cardinality, [3, 4, 6, 3])
    return model
...
def resnext101_ibn_a(last_stride, baseWidth=4, cardinality=32):
    ...
    """
    model = ResNeXt(last_stride, baseWidth, cardinality, [3, 4, 23, 3])
    return model
...
def resnext152_ibn_a(last_stride, baseWidth, cardinality):
    ...
    """
    model = ResNeXt(last_stride, baseWidth, cardinality, [3, 8, 36, 3])
    return model
